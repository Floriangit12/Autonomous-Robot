...
@REM python RecordPath.py -n 30 -w 80  --nameFile walker_Town10_0 --maps Town10 --sync --sample-period 0.5 --target-frames 7500 --ego-type walker --output "%output_traj%"

@REM python RecordPath.py -n 30 -w 80  --nameFile walker_Town10_1 --maps Town10 --sync --sample-period 0.5 --target-frames 10000 --ego-type walker --output "%output_traj%"

@REM python RecordPath.py -n 50 -w 60  --nameFile walker_Town10_2 --maps Town10 --sync --sample-period 0.5 --target-frames 10000 --ego-type walker --output "%output_traj%"

@REM python RecordPath.py -n 50 -w 60  --nameFile walker_Town10_3 --maps Town10 --sync --sample-period 0.5 --target-frames 7500 --ego-type walker --output "%output_traj%"
